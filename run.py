...
วิธีใช้:
    ...
    python run.py agent      # รัน Orchestrator.run_task() จริงบน saucedemo.com
                              ...
                              # จริงใน .env) — โชว์แผนก่อนแล้วรอกด y/n ยืนยันก่อน
                              # ค่อยเริ่ม loop จริง (confirm_plan=True) + ถ้าเจอ
                              # action เสี่ยง (submit/delete/purchase/pay หรือ
                              # goto โดเมนที่บล็อกไว้) จะหยุดถามยืนยันอีกรอบ

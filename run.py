...
_TEST_CASE_B_TASK1_GOAL = (
    "Log in as standard_user/secret_sauce, find the price of 'Sauce Labs Backpack' "
    "on the inventory page, and report the exact price (e.g. $29.99) in your final message"
)
_TEST_CASE_B_TASK2_GOAL = (
    "Log in as standard_user/secret_sauce, add 'Sauce Labs Backpack' to the cart, "
    "go to checkout, fill First Name with 'Test' and Last Name with 'User', then use the "
    "information from the previous task to fill the Zip Code field, then click Continue"
)

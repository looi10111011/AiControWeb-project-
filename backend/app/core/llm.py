...
กติกา:
- เลือก action ได้จาก index ที่เห็นในหน้าปัจจุบันเท่านั้น ห้ามเดา index ที่ไม่อยู่ในลิสต์ (ยกเว้นคำสั่งที่ไม่ต้องใช้ index อย่างเช่น goto, go_back, scroll, wait)
